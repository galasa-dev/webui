...
if [[ -z $OPENAPI_GENERATOR_CLI_JAR ]]; then
    ...
    echo "Set the OPENAPI_GENERATOR_CLI_JAR environment variable to override this setting."
    exit 1
fi
...
echo "Folder ${BASEDIR}/webui/galasa-ui/src/generated/galasaapi has been generated with content inside"
